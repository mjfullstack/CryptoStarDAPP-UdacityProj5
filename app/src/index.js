...
const App = {
  ...
  lookUp: async function (){
    ...
    console.log("Hello from ./app/SRC/index.js: Kindly look up Star ID: ", lookid);
    let foundStar = await lookUptokenIdToStarInfo(lookid).call();
    console.log("foundStar: ", foundStar);
    App.setStatus("Found Star ID " + lookid + " with NAME --->  " + foundStar + "  <---.");
  }
